...
public struct Recipe: Identifiable {
    ...
    public let instructions: NSAttributedString
    ...
    public init(id : String, name: String, ingredients: [String], instructions: NSAttributedString, image: String, category: RecipeCategory, rating: Double, time: String, calories: String, tags: [RecipeTag]) {
        self.id = id
        self.name = name
